...
const CustomerNav = () => {
    ...
    const handleLogout = () => {
        logout();
        router.push('/service-admin/customer/login');
    };

    const navLinks = [
        { label: 'Dashboard', href: '/service-admin/customer/dashboard' },
        { label: 'Request Service', href: '/service-admin/customer/request-service' },
        { label: 'Tracking', href: '/service-admin/customer/track' },
        { label: 'History', href: '/service-admin/customer/history' },
    ];
    ...
    return (
        <nav className="bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-surface-border dark:border-dark-border sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                {/* Logo */}
                <Link href="/service-admin/customer/dashboard" className="flex items-center gap-3 group">
