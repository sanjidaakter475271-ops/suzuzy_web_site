...
import POSLayout from '@/components/service-admin/pos/POSLayout'; // Correct import path
import ProductGrid from '@/components/service-admin/pos/ProductGrid';
import Cart from '@/components/service-admin/pos/Cart'; // Ensure this path is correct
