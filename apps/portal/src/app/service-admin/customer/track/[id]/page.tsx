...
const CustomerLiveTracking = () => {
    ...
    if (!job) return (
        <div className="flex flex-col items-center justify-center py-20 text-center space-y-6 animate-fade">
            ...
            <Button onClick={() => router.push('/service-admin/customer/dashboard')} variant="outline" className="rounded-2xl px-10 h-14 uppercase tracking-widest text-xs font-black border-2 border-surface-border">Go to Dashboard</Button>
        </div>
    );
