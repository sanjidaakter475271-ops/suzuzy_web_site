...
const AppointmentsOverviewPage = () => {
    const menuItems = [
        ...
        { title: "Online Booking", icon: Clock, path: "/service-admin/appointments/online", color: "bg-blue-500", desc: "Manage online bookings from customers." },
        { title: "Reschedule/Cancel", icon: Calendar, path: "/service-admin/appointments/reschedule", color: "bg-danger", desc: "Change or cancel existing appointments." },
        { title: "Reminders", icon: Bell, path: "/service-admin/appointments/reminders", color: "bg-slate-800", desc: "Configure service reminder settings." },
    ];
