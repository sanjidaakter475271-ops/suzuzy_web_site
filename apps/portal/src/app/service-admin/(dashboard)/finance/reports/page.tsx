...
import FinanceReportHeader from '@/components/service-admin/finance/FinanceReportHeader';
import CashBookTable from '@/components/service-admin/finance/CashBookTable';
import DailySalesTable from '@/components/service-admin/finance/DailySalesTable';
import ExpenseTable from '@/components/service-admin/finance/ExpenseTable';
import DepositWithdrawTable from '@/components/service-admin/finance/DepositWithdrawTable';
import {
    CASHBOOK_DATA,
    DAILY_SALES_DATA,
    EXPENSE_DATA,
    ...
    FINANCE_SUMMARY
} from '@/constants/service-admin/financeData';
    ...
    return (
        <div className="p-6 lg:p-8 space-y-12 animate-fade bg-white dark:bg-dark-page print:p-0 print:m-0 print:bg-white text-black min-h-screen">
            <div className="print:hidden">
                <Breadcrumb
                    items={[
                        { label: 'Finance', href: '/service-admin/finance' },
