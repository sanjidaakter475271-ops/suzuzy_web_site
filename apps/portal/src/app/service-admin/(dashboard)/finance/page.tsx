...
import { FINANCE_SUMMARY } from '@/constants/service-admin/financeData';

const FinanceOverviewPage = () => {
    const menuItems = [
        { title: "CashBook Report", icon: BookOpen, path: "/service-admin/finance/cashbook", color: "bg-brand", desc: "View detailed cash in/out and daily balance." },
        { title: "Daily Sales", icon: ShoppingBag, path: "/service-admin/finance/daily-sales", color: "bg-success", desc: "Detailed breakdown of daily sales and invoices." },
        { title: "Expenses", icon: Receipt, path: "/service-admin/finance/expenses", color: "bg-danger", desc: "Track all company expenses and distributions." },
        { title: "Deposits/Withdraw", icon: Wallet, path: "/service-admin/finance/deposits", color: "bg-info", desc: "Monitor bank deposits and cash withdrawals." },
        { title: "Combined Reports", icon: BarChart3, path: "/service-admin/finance/reports", color: "bg-slate-800", desc: "Full financial statement report in PDF format." },
    ];
