...
const ServiceRulesPage = () => {
    return (
        <div className="p-6 lg:p-8 space-y-6 animate-fade">
            <Breadcrumb items={[{ label: 'Settings' }, { label: 'Service Rules' }]} />
            
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-ink-heading dark:text-white uppercase tracking-tight">Service Rules</h1>
