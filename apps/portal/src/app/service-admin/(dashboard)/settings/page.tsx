...
const SettingsOverviewPage = () => {
    const menuItems = [
        { title: "General", icon: Globe, path: "/service-admin/settings/general", color: "bg-blue-500", desc: "Company profile, branding, and localization." },
        { title: "Notifications", icon: Bell, path: "/service-admin/settings/notifications", color: "bg-amber-500", desc: "Email and SMS alert preferences." },
        { title: "Security", icon: Shield, path: "/service-admin/settings/security", color: "bg-danger", desc: "Password policy and login sessions." },
        { title: "Data & Backup", icon: Database, path: "/service-admin/settings/data", color: "bg-purple-600", desc: "Scheduled backups and data export." },
        { title: "Theme & UI", icon: Palette, path: "/service-admin/settings/theme", color: "bg-brand", desc: "Customize application appearance." },
    ];

    return (
        <div className="p-6 lg:p-8 space-y-8 animate-fade">
            <Breadcrumb items={[{ label: 'System', href: '/service-admin/settings' }, { label: 'Settings' }]} />
