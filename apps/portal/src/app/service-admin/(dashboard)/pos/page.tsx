...
const POSOverviewPage = () => {
    const menuItems = [
        { title: "Counter Sale", icon: ShoppingCart, path: "/service-admin/pos/terminal", color: "bg-brand", desc: "Quick parts & accessories sales." },
        { title: "Service Billing", icon: FileText, path: "/service-admin/pos/service-billing", color: "bg-blue-600", desc: "Invoice generation for job cards." },
        { title: "Quotations", icon: FileText, path: "/service-admin/pos/quotations", color: "bg-amber-500", desc: "Create and manage price estimates." },
        { title: "Invoices", icon: Archive, path: "/service-admin/pos/invoices", color: "bg-purple-600", desc: "View all past transactions." },
        { title: "Daily Closing", icon: Box, path: "/service-admin/pos/closing", color: "bg-emerald-600", desc: "End of day reconciliation." },
    ];
